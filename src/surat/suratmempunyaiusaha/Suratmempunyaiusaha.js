...
import contractmempunyaiusaha from './contractmempunyaiusaha';
  ...
  return (
    <div>
      ...
      <div className="login-container" style={{ marginTop: '180px' }}>
        <h3 style={{ color: 'white', marginBottom: '5px' }}>Isi Surat Mempunyai Usaha</h3>
        <hr style={{ marginBottom: '50px', width: '240px', color: 'white' }} />
      ...
      <div style={{ paddingLeft: '3px', paddingRight: '12px', marginBottom: '10px' }} className="password-input">
          ...
          <Form.Group as={Row}>
          <p style={{ fontWeight: 'bold', color: 'white', textAlign: 'left', lineHeight: '5px', paddingLeft: '5px' }}>Nama Usaha</p>
              <Col sm="8.5">
                <Form.Control
                  type="text"
                  name="namaUsaha"
        ...
        <Form.Group as={Row}>
        <p style={{ fontWeight: 'bold', color: 'white', textAlign: 'left', lineHeight: '5px', paddingLeft: '5px' }}>Jenis Usaha</p>
              <Col sm="8.5">
                <Form.Control
                  type="text"
                  name="jenisUsaha"
        ...
        <Form.Group as={Row}>
        <p style={{ fontWeight: 'bold', color: 'white', textAlign: 'left', lineHeight: '5px', paddingLeft: '5px' }}>Alamat Usaha</p>
              <Col sm="8.5">
                <Form.Control
                  type="text"
                  name="alamatUsaha"
        ...
        <p style={{ fontWeight: 'bold', color: 'white', textAlign: 'left', lineHeight: '5px', paddingLeft: '5px' }}>Keperluan</p>
          ...
          <Button style={{ marginTop: '50px' }} variant="primary" onClick={createMempunyaiusaha}>
            Tambah
          </Button>
        </Form>
