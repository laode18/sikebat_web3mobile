    ...
    <Container>
      ...
      {isLoading ? (
        ...
        <Table striped bordered hover>
          ...
          <tbody>
          {bersihdiris.map((bersihdiri, index) => (
                <tr key={index}>
                  <td>{bersihdiri.userId}</td>
                  <td>{bersihdiri.namaAyah}</td>
                  <td>{bersihdiri.namaIbu}</td>
                  <td>{bersihdiri.keperluan}</td>
                  <td>{bersihdiri.letterNumber}</td>
                  {/* Add more table cells for other user fields */}
                  <td>
                  <Button variant="primary" onClick={() => setEditingBersihdiri(bersihdiri)}>
                      Edit
                    </Button>{' '}
                    <Button variant="danger" onClick={() => deleteBersihdiri(index)}>
                      Hapus
                    </Button>
                  </td>
                </tr>
      ...
      {editingBersihdiri && (
        <div>
          ...
          <Form>
            ...
            <Button variant="danger" onClick={() => setEditingBersihdiri(null)}>
              Batal
            </Button>
          </Form>
        </div>
